...
function handleDeleteLetter() {
  ...
  deleteLetter(viewingLetter.value, props.worldBookId)
}
      ...
      <div class="letter-detail">
        ...
        <div class="letter-actions">
          <button
            ...
            @click="toggleFavorite(viewingLetter, worldBookId)"
          >
...
.letter-action-icon { font-size: 16px; }
.letter-action-text { font-weight: 600; }
...
.waiting-dots span {
  ...
  animation: waiting-bounce 1.5s ease-in-out infinite;
}
.waiting-dots span:nth-child(1) { animation-delay: 0s; }
.waiting-dots span:nth-child(2) { animation-delay: 0.1s; }
.waiting-dots span:nth-child(3) { animation-delay: 0.2s; }
.waiting-dots span:nth-child(4) { animation-delay: 0.3s; }
.waiting-dots span:nth-child(5) { animation-delay: 0.4s; }
.waiting-dots span:nth-child(6) { animation-delay: 0.5s; }
.waiting-dots span:nth-child(7) { animation-delay: 0.6s; }
.waiting-dots span:nth-child(8) { animation-delay: 0.7s; }
