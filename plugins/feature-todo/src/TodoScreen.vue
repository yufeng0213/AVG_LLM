...
<template>
  <div class="todo-screen">
    ...
    <div class="todo-content">
      <template v-for="cat in todo.CATEGORY_ORDER" :key="cat">
        <div v-if="groupedTodos()[cat]" class="category-section">
...
.footer-btn.save {
  ...
  .platform-android.android-portrait .todo-header {
    background: rgba(28, 28, 30, 0.98) !important;
  }

  .platform-android.android-portrait .filter-btn,
  .platform-android.android-portrait .footer-btn,
  .platform-android.android-portrait .modal-close,
  .platform-android.android-portrait .check-btn,
  .platform-android.android-portrait .todo-delete {
